...
public class GeneralPostComment {
    ...
    public GeneralPostComment () {}

    public ResponseEntity addComments (HttpServletRequest request, Integer parentId, int postId, String text) {
        return ResponseEntity.status(HttpStatus.OK).body(new GeneralPostComment(request, parentId, postId, text));
    }
}
