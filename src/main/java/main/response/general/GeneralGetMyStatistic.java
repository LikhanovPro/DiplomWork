...
public class GeneralGetMyStatistic {
    ...
    private GeneralGetMyStatistic (HttpServletRequest request) {
    ...
    public GeneralGetMyStatistic () {}

    public ResponseEntity getMyStatistic (HttpServletRequest request) {

        return ResponseEntity.status(HttpStatus.OK).body(new GeneralGetMyStatistic(request));
    }
