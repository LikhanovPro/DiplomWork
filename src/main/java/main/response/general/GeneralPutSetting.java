...
public class GeneralPutSetting {
    ...
    private GeneralPutSetting (HttpServletRequest request) {
    ...
    public GeneralPutSetting () {}

    public ResponseEntity putSetting (HttpServletRequest request) {
        return ResponseEntity.status(HttpStatus.OK).body(new GeneralPutSetting(request));
    }
