...
public class PostGetSearch {
    ...
    private PostGetSearch (int offset, int limit, String query) {
    ...
    private static Map <Object, Object> getPostInformation (Integer postId, PostsRepository postsRepository) {
    ...
    public PostGetSearch () {}

    public ResponseEntity getPosts (int offset, int limit, String query) {
        return ResponseEntity.status(HttpStatus.OK).body(new PostGetSearch(offset, limit, query));
    }
}
