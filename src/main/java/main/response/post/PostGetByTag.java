...
public class PostGetByTag {
    ...
    private PostGetByTag (int offset, int limit, String tag) {
    ...
    public ResponseEntity getPost (int offset, int limit, String tag) {
        return ResponseEntity.status(HttpStatus.OK).body(new PostGetByTag(offset, limit, tag));
    }
}
