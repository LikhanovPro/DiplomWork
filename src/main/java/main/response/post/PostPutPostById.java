...
public class PostPutPostById {
    ...
    private PostPutPostById (HttpServletRequest request, Date time, boolean active, String title, String text, String tags, int id) {
    ...
    public PostPutPostById () {}

    public ResponseEntity changePost (HttpServletRequest request, Date time, boolean active, String title, String text, String tags, int id) {
        return ResponseEntity.status(HttpStatus.OK).body(new PostPutPostById(request, time, active, title, text, tags, id));
    }
}
