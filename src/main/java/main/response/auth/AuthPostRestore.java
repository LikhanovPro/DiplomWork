...
public class AuthPostRestore {
    ...
    private AuthPostRestore (AuthPostRestoreObject information, String supportMail, String supportMailPassword) {
    ...
    public AuthPostRestore () {    }

    public ResponseEntity getAuthPostRestore (AuthPostRestoreObject information, String supportMail, String supportMailPassword) {
        return ResponseEntity.status(HttpStatus.OK).body(new AuthPostRestore(information, supportMail, supportMailPassword));
    }
}
