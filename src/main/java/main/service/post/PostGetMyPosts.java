...
public class PostGetMyPosts {
    ...
    public PostGetMyPosts (HttpServletRequest request, int offset, int limit, String status, PostsRepository postsRepository) {
    ...
    public static Map <Object, Object> getMyPostInformation (Posts post) {
