...
public class PostGetPostsForModeration {
    ...
    public PostGetPostsForModeration (HttpServletRequest request, int offset, int limit, String status, PostsRepository postsRepository) {
    ...
    public static Map <Object, Object> getPostInformationForModeration (Posts post) {
